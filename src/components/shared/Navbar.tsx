...
export const Navbar = () => {
  return (
    <nav className="flex justify-between h-12 items-center px-5 w-full text-slate-600 bg-gray-100 z-10 shadow-sm text-[12px] sm:text-xl md:text-xl">
      <NavLink to={"/"} className={"flex items-center gap-1 group "}>
        <div className="text-3xl group-hover:scale-105">📚</div>
